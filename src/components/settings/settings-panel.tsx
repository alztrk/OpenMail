  ...
  return <div className="settings-layout">
    ...
    <div className="settings-content">
      ...
      {activeTab === 'general' ? <section className="settings-section">
        <SettingRow label={t('launchAtStartup')} description={t('launchAtStartupDescription')}><Switch className="setting-toggle" checked={settings.launchAtStartup} onChange={(e) => onChange('launchAtStartup', e.target.checked)} /></SettingRow>
        <SettingRow label={t('minimizeToTray')} description={t('minimizeToTrayDescription')}><Switch className="setting-toggle" checked={settings.minimizeToTray} onChange={(e) => onChange('minimizeToTray', e.target.checked)} /></SettingRow>
        <SettingRow label={t('closeToTray')} description={t('closeToTrayDescription')}><Switch className="setting-toggle" checked={settings.closeToTray} onChange={(e) => onChange('closeToTray', e.target.checked)} /></SettingRow>
        <SettingRow label={t('confirmOnClose')} description={t('confirmOnCloseDescription')}><Switch className="setting-toggle" checked={settings.confirmOnClose} onChange={(e) => onChange('confirmOnClose', e.target.checked)} /></SettingRow>
        <SettingRow label={t('confirmActions')} description={t('confirmActionsDescription')}><Switch className="setting-toggle" checked={settings.confirmActions} onChange={(e) => onChange('confirmActions', e.target.checked)} /></SettingRow>
      </section> : null}
      {activeTab === 'appearance' ? <section className="settings-section">
        ...
        <SettingRow label={t('globalFontSize')} description={t('globalFontSizeDescription')}><Slider min="0.9" max="1.2" step="0.05" value={settings.fontScale} onChange={(e) => onChange('fontScale', Number(e.target.value))} /></SettingRow>
        <SettingRow label={t('readerFontSize')} description={t('readerFontSizeDescription')}><Slider min="0.9" max="1.3" step="0.05" value={settings.readerFontScale} onChange={(e) => onChange('readerFontScale', Number(e.target.value))} /></SettingRow>
        <SettingRow label={t('sidebarWidth')} description={t('sidebarWidthDescription')}><Slider min="280" max="420" step="4" value={settings.sidebarWidth} onChange={(e) => onChange('sidebarWidth', Number(e.target.value))} /></SettingRow>
        <SettingRow label={t('readerWidth')} description={t('readerWidthDescription')}><Slider min="560" max="1000" step="20" value={settings.readerWidth} onChange={(e) => onChange('readerWidth', Number(e.target.value))} /></SettingRow>
      ...
      {activeTab === 'notifications' ? <section className="settings-section">
        <SettingRow label={t('notificationsEnabled')} description={t('notificationsEnabledDescription')}><Switch className="setting-toggle" checked={settings.notificationsEnabled} onChange={(e) => onChange('notificationsEnabled', e.target.checked)} /></SettingRow>
        <SettingRow label={t('notificationSound')} description={t('notificationSoundDescription')}><Switch className="setting-toggle" checked={settings.notificationSound} disabled={!settings.notificationsEnabled} onChange={(e) => onChange('notificationSound', e.target.checked)} /></SettingRow>

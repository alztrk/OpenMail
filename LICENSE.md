...
Copyright 2026 OpenMail contributors.

OpenMail is licensed under the PolyForm Noncommercial License 1.0.0. The complete, authoritative license text is included below and is also available at:

https://polyformproject.org/licenses/noncommercial/1.0.0

## Plain-language project summary

You may use, study, modify, and distribute OpenMail for noncommercial purposes, including personal use, research, education, hobby projects, and other permitted noncommercial purposes.

You may not sell OpenMail, sell copies of OpenMail, include OpenMail in a product or service offered for payment, or use OpenMail for a commercial purpose without separate written permission from the copyright holder.

The linked PolyForm Noncommercial License 1.0.0 is the governing legal text. If this summary conflicts with that license, the license controls.

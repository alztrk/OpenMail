...
1. [Microsoft Graph](microsoft-graph.md) for Outlook, Hotmail, Live, and Microsoft 365. The adapter, persisted delta cursor path, provider recovery states, and attachment upload-session path are implemented; live-provider and portable-release verification remain follow-up work.
